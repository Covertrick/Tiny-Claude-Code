---
name: pdf
description: 处理 PDF 文件——提取文本、创建 PDF、合并文档。在用户要求阅读、创建或处理 PDF 时使用。
---

# PDF 处理 Skill

你现在具备 PDF 操作能力。请按以下工作流进行：
...
1. **使用前先确认工具已安装**
2. **注意编码问题** — PDF 可能包含多种字符编码
3. **大文件**：逐页处理，避免内存压力
4. **扫描版 PDF 的 OCR**：文本提取为空时可用 `pytesseract`
